    ...
    <div ref={wrapperRef} className={`relative w-full ${className}`}>
      ...
      <button
        ...
        className="
          ...
          px-4 pr-10 text-left text-gray-900
                                ...
                                {({ field: f }: FieldProps) => (
                                  <>
                                    <Input
                                      type="date"
                                      {...f}
                                      className={`h-12 bg-white border-2 border-gray-300 rounded-xl transition-all duration-200focus:outline-none focus:ring-2 focus:ring-orange-500 text-gray-900 pr-4 ${
                                        field.Icon ? "pl-12" : "pl-4"
                                              ...
                                              return (
                                                ...
                                                >
                                                  <input
                                                    ...
                                                    className="peer h-5 w-5 shrink-0 rounded border-2 ring-offset-background focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-orange-500 focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50 cursor-pointer appearance-none checked:bg-orange-500 checked:border-orange-500 relative
                            checked:after:content-['✓'] checked:after:absolute checked:after:text-white checked:after:text-xs checked:after:left-1/2 checked:after:top-1/2 checked:after:-translate-x-1/2 checked:after:-translate-y-1/2 checked:after:font-bold"
                                                  />
                                                  <label
                                ...
                                {({ field: f }: FieldProps) => (
                                  <>
                                    <Input
                                      ...
                                      placeholder={field.placeholder}
                                      className={`h-12 bg-white border-2 border-gray-300 rounded-xl transition-all duration-200focus:outline-none focus:ring-2 focus:ring-orange-500 text-gray-900 ${
                                        field.Icon ? "pl-12" : "pl-4"
                                      }`}
                                    />
                                    {field.Icon && (
