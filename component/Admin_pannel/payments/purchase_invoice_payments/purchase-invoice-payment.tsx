...
import PurchaseInvoicesPaymentTab from "./tabs/purchase_invoice_payment";
import OtherComponentTab from "./tabs/payment-settlement-tabs";
// import OtherComponentTab from "./tabs/otherstabs";
// import PurchaseInvoicesTab from "./tabs/purchaseinvoicetabs";
export default function PurchaseInvoicePaymentComponent() {
